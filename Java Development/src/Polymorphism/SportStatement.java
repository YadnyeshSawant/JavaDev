...
class Football extends Sport{
	void play() {
		System.out.println("Football game has 11 players in one team");
	}
}
class Basketball extends Sport{
	void play() {
		System.out.println("Basketball game has 5 players in one team");
	}
}
class Rugby extends Sport{
	void play() {
		System.out.println("Rugby game has 15 players in one team");
	}
}
public class SportStatement {
