...
// Class for operation on saving account
...
//		System.out.println("Enter Amount");
//		amount = sc.nextDouble();
		if(super.amount - super.balance >= (super.minBalance)) {
			System.out.println("Exceded minimum balance amout");
			System.out.println("Minimum balance should be "+super.minBalance);
		}
		else {
...
//Class for operation on Current account
...
//Public class to recreate the bank transaction
